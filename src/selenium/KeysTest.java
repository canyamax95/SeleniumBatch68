...
public class KeysTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.id("signIn")).click();  // This is when you hit signin button to login
		driver.findElement(By.name("password")).sendKeys(Keys.ENTER); // This is when you hit Enter button to login
